...
const mapStateToProps: MapStateToProps<{todos: TodoListProps['todos']}, {}, State> = (state, a) => ({
  todos: getVisibleTodos(state.todos, state.visibilityFilter)
});

const mapDispatchToProps: MapDispatchToProps<{ toggleTodo: TodoListProps['toggleTodo'] }, {}> = dispatch => ({
